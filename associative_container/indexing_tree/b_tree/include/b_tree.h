...
class B_tree final : private compare  // EBCO
{
   ...
   private:
    ...
    struct btree_node {
        // лежат сразу в структуре последовательно
   ...
   public:
    ...
    class btree_iterator final {
       ...
       public:
        ...
        explicit btree_iterator(const std::stack<std::pair<btree_node**, size_t>>& path =
    ...
    class btree_reverse_iterator final {
       ...
       public:
        ...
        explicit btree_reverse_iterator(const std::stack<std::pair<btree_node**, size_t>>& path =
                                            std::stack<std::pair<btree_node**, size_t>>(),
                                        size_t index = 0);
    };
    ...
    /*
     * Returns a reference to the mapped value of the element with specified key. If no such element
...
B_tree<tkey, tvalue, compare, t>::B_tree(pp_allocator<value_type> alloc, const compare& comp)
    : _allocator(alloc), comparator(cmp), _root(nullptr), _size(0) {}

template <typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t>
template <input_iterator_for_pair<tkey, tvalue> iterator>
B_tree<tkey, tvalue, compare, t>::B_tree(iterator begin, iterator end, const compare& cmp,
                                         pp_allocator<value_type> alloc)
    : comparator(cmp), _allocator(alloc), _root(nullptr), _size(0) {
...
B_tree<tkey, tvalue, compare, t>& B_tree<tkey, tvalue, compare, t>::operator=(const B_tree& other) {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> "
        "B_tree<tkey, tvalue, compare, t>& B_tree<tkey, tvalue, compare, t>::operator=(const "
        "B_tree& other)",
        "your code should be here...");
}
...
template <typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t>
B_tree<tkey, tvalue, compare, t>& B_tree<tkey, tvalue, compare, t>::operator=(
    B_tree&& other) noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> "
        "B_tree<tkey, tvalue, compare, t>& B_tree<tkey, tvalue, compare, t>::operator=(B_tree&& "
        "other) noexcept",
        "your code should be here...");
}
...
B_tree<tkey, tvalue, compare, t>::btree_iterator::btree_iterator(
    ...
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> "
        "B_tree<tkey, tvalue, compare, t>::btree_iterator::btree_iterator(const "
...
B_tree<tkey, tvalue, compare, t>::btree_iterator::operator*() const noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> "
        "typename B_tree<tkey, tvalue, compare, t>::btree_iterator::reference B_tree<tkey, tvalue, "
        "compare, t>::btree_iterator::operator*() const noexcept",
        "your code should be here...");
}
...
B_tree<tkey, tvalue, compare, t>::btree_iterator::operator->() const noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> "
        "typename B_tree<tkey, tvalue, compare, t>::btree_iterator::pointer B_tree<tkey, tvalue, "
        "compare, t>::btree_iterator::operator->() const noexcept",
        "your code should be here...");
}
...
B_tree<tkey, tvalue, compare, t>::btree_iterator::operator++() {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> "
        "typename B_tree<tkey, tvalue, compare, t>::btree_iterator& B_tree<tkey, tvalue, compare, "
...
bool B_tree<tkey, tvalue, compare, t>::btree_iterator::operator==(
    ...
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> bool "
        "B_tree<tkey, tvalue, compare, t>::btree_iterator::operator==(const self& other) const "
        "noexcept",
        "your code should be here...");
}
...
size_t B_tree<tkey, tvalue, compare, t>::btree_iterator::depth() const noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> size_t "
...
size_t B_tree<tkey, tvalue, compare, t>::btree_iterator::current_node_keys_count() const noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> size_t "
        "B_tree<tkey, tvalue, compare, t>::btree_iterator::current_node_keys_count() const "
        "noexcept",
        "your code should be here...");
}
...
bool B_tree<tkey, tvalue, compare, t>::btree_iterator::is_terminate_node() const noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> bool "
        "B_tree<tkey, tvalue, compare, t>::btree_iterator::is_terminate_node() const noexcept",
        "your code should be here...");
}
...
bool B_tree<tkey, tvalue, compare, t>::btree_const_iterator::operator==(
    ...
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> bool "
        "B_tree<tkey, tvalue, compare, t>::btree_const_iterator::operator==(const self& other) "
        "const noexcept",
        "your code should be here...");
}
...
template <typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t>
size_t B_tree<tkey, tvalue, compare, t>::btree_const_iterator::current_node_keys_count()
    const noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> size_t "
        "B_tree<tkey, tvalue, compare, t>::btree_const_iterator::current_node_keys_count() const "
        "noexcept",
        "your code should be here...");
}
...
bool B_tree<tkey, tvalue, compare, t>::btree_const_iterator::is_terminate_node() const noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> bool "
        "B_tree<tkey, tvalue, compare, t>::btree_const_iterator::is_terminate_node() const "
        "noexcept",
        "your code should be here...");
}
...
B_tree<tkey, tvalue, compare, t>::btree_reverse_iterator::operator B_tree<
    ...
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> "
        "B_tree<tkey, tvalue, compare, t>::btree_reverse_iterator::operator btree_iterator() const "
        "noexcept",
        "your code should be here...");
}
...
bool B_tree<tkey, tvalue, compare, t>::btree_reverse_iterator::operator==(
    ...
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> bool "
        "B_tree<tkey, tvalue, compare, t>::btree_reverse_iterator::operator==(const self& other) "
        "const noexcept",
        "your code should be here...");
}
...
size_t B_tree<tkey, tvalue, compare, t>::btree_reverse_iterator::depth() const noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> size_t "
        "B_tree<tkey, tvalue, compare, t>::btree_reverse_iterator::depth() const noexcept",
        "your code should be here...");
}

template <typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t>
size_t B_tree<tkey, tvalue, compare, t>::btree_reverse_iterator::current_node_keys_count()
    const noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> size_t "
        "B_tree<tkey, tvalue, compare, t>::btree_reverse_iterator::current_node_keys_count() const "
        "noexcept",
        "your code should be here...");
}
...
bool B_tree<tkey, tvalue, compare, t>::btree_reverse_iterator::is_terminate_node() const noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> bool "
        "B_tree<tkey, tvalue, compare, t>::btree_reverse_iterator::is_terminate_node() const "
        "noexcept",
        "your code should be here...");
}
...
size_t B_tree<tkey, tvalue, compare, t>::btree_reverse_iterator::index() const noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> size_t "
        "B_tree<tkey, tvalue, compare, t>::btree_reverse_iterator::index() const noexcept",
        "your code should be here...");
}
...
B_tree<tkey, tvalue, compare, t>::btree_const_reverse_iterator::operator B_tree<
    ...
    throw not_implemented(
        ...
        "btree_const_iterator() const noexcept",
        "your code should be here...");
}
...
B_tree<tkey, tvalue, compare, t>::btree_const_reverse_iterator::operator*() const noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t>\n"
        "typename B_tree<tkey, tvalue, compare, t>::btree_const_reverse_iterator::reference\n"
        "B_tree<tkey, tvalue, compare, t>::btree_const_reverse_iterator::operator*() const "
        "noexcept",
        "your code should be here...");
}
...
bool B_tree<tkey, tvalue, compare, t>::btree_const_reverse_iterator::operator==(
    ...
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> bool "
        "B_tree<tkey, tvalue, compare, t>::btree_const_reverse_iterator::operator==(const self& "
...
size_t B_tree<tkey, tvalue, compare, t>::btree_const_reverse_iterator::depth() const noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> size_t "
        "B_tree<tkey, tvalue, compare, t>::btree_const_reverse_iterator::depth() const noexcept",
        "your code should be here...");
}

template <typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t>
size_t B_tree<tkey, tvalue, compare, t>::btree_const_reverse_iterator::current_node_keys_count()
    const noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> size_t "
        "B_tree<tkey, tvalue, compare, t>::btree_const_reverse_iterator::current_node_keys_count() "
        "const noexcept",
        "your code should be here...");
}

template <typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t>
bool B_tree<tkey, tvalue, compare, t>::btree_const_reverse_iterator::is_terminate_node()
    const noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> bool "
        "B_tree<tkey, tvalue, compare, t>::btree_const_reverse_iterator::is_terminate_node() const "
        "noexcept",
        "your code should be here...");
}
...
size_t B_tree<tkey, tvalue, compare, t>::btree_const_reverse_iterator::index() const noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> size_t "
        "B_tree<tkey, tvalue, compare, t>::btree_const_reverse_iterator::index() const noexcept",
        "your code should be here...");
}
...
tvalue& B_tree<tkey, tvalue, compare, t>::at(const tkey& key) {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> tvalue& "
...
const tvalue& B_tree<tkey, tvalue, compare, t>::at(const tkey& key) const {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> const "
        "tvalue& B_tree<tkey, tvalue, compare, t>::at(const tkey& key) const",
        "your code should be here...");
}
...
tvalue& B_tree<tkey, tvalue, compare, t>::operator[](const tkey& key) {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> tvalue& "
        "B_tree<tkey, tvalue, compare, t>::operator[](const tkey& key)",
        "your code should be here...");
}
...
tvalue& B_tree<tkey, tvalue, compare, t>::operator[](tkey&& key) {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> tvalue& "
        "B_tree<tkey, tvalue, compare, t>::operator[](tkey&& key)",
        "your code should be here...");
}
...
B_tree<tkey, tvalue, compare, t>::begin() const {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> "
        "typename B_tree<tkey, tvalue, compare, t>::btree_const_iterator B_tree<tkey, tvalue, "
        "compare, t>::begin() const",
        "your code should be here...");
}
...
B_tree<tkey, tvalue, compare, t>::rbegin() {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> "
        "typename B_tree<tkey, tvalue, compare, t>::btree_reverse_iterator B_tree<tkey, tvalue, "
        "compare, t>::rbegin()",
        "your code should be here...");
}
...
B_tree<tkey, tvalue, compare, t>::rbegin() const {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> "
        "typename B_tree<tkey, tvalue, compare, t>::btree_const_reverse_iterator B_tree<tkey, "
        "tvalue, compare, t>::rbegin() const",
        "your code should be here...");
}
...
B_tree<tkey, tvalue, compare, t>::crbegin() const {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> "
        "typename B_tree<tkey, tvalue, compare, t>::btree_const_reverse_iterator B_tree<tkey, "
        "tvalue, compare, t>::crbegin() const",
        "your code should be here...");
}
...
size_t B_tree<tkey, tvalue, compare, t>::size() const noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> size_t "
        "B_tree<tkey, tvalue, compare, t>::size() const noexcept",
        "your code should be here...");
}
...
bool B_tree<tkey, tvalue, compare, t>::empty() const noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> bool "
        "B_tree<tkey, tvalue, compare, t>::empty() const noexcept",
        "your code should be here...");
}

template <typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t>
typename B_tree<tkey, tvalue, compare, t>::btree_iterator B_tree<tkey, tvalue, compare, t>::find(
    const tkey& key) {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> "
        "typename B_tree<tkey, tvalue, compare, t>::btree_iterator B_tree<tkey, tvalue, compare, "
...
B_tree<tkey, tvalue, compare, t>::find(const tkey& key) const {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> "
        "typename B_tree<tkey, tvalue, compare, t>::btree_const_iterator B_tree<tkey, tvalue, "
        "compare, t>::find(const tkey& key) const",
        "your code should be here...");
}
...
B_tree<tkey, tvalue, compare, t>::lower_bound(const tkey& key) const {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> "
        "typename B_tree<tkey, tvalue, compare, t>::btree_const_iterator B_tree<tkey, tvalue, "
        "compare, t>::lower_bound(const tkey& key) const",
        "your code should be here...");
}
...
B_tree<tkey, tvalue, compare, t>::upper_bound(const tkey& key) const {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> "
        "typename B_tree<tkey, tvalue, compare, t>::btree_const_iterator B_tree<tkey, tvalue, "
        "compare, t>::upper_bound(const tkey& key) const",
        "your code should be here...");
}
...
bool B_tree<tkey, tvalue, compare, t>::contains(const tkey& key) const {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> bool "
        "B_tree<tkey, tvalue, compare, t>::contains(const tkey& key) const",
        "your code should be here...");
}
...
void B_tree<tkey, tvalue, compare, t>::clear() noexcept {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t> void "
        "B_tree<tkey, tvalue, compare, t>::clear() noexcept",
        "your code should be here...");
}
...
typename B_tree<tkey, tvalue, compare, t>::btree_iterator B_tree<tkey, tvalue, compare, t>::erase(
    ...
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t t>\n"
        "typename B_tree<tkey, tvalue, compare, t>::btree_iterator\n"
        "B_tree<tkey, tvalue, compare, t>::erase(btree_const_iterator beg, btree_const_iterator "
        "en)",
        "your code should be here...");
}
...
bool compare_keys(const tkey& lhs, const tkey& rhs) {
    throw not_implemented(
        "template<typename tkey, typename tvalue, comparator<tkey> compare, std::size_t >\n"
        "bool compare_keys(const tkey &lhs, const tkey &rhs)",
        "your code should be here...");
}
